...
**2026/03/05 Update** 添加对切换**思考模式**的支持，您可以从[v0.0.4](https://github.com/Strivy-ZSY/pot-app-recognize-plugin-ollama/releases/tag/v0.0.4)下载🙂

**2026/03/04 Update**：插件修复了glm-ocr无法使用的问题，您可以从[v0.0.3-ss](https://github.com/Strivy-ZSY/pot-app-recognize-plugin-ollama/releases/tag/v0.0.3-ss)下载🤗
同时，`maternion/LightOnOCR-2`也不错。
